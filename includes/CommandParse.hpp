...
/*   Updated: 2023/04/07 16:25:26 by uisroilo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
	...
	std::string		getCmd();
	void		parse(std::string recieved_msg, std::vector<Users>	_User, std::vector<Channels> _Channels, int newFd, std::string _servername) throw(std::runtime_error);
