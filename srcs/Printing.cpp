...
/*   Updated: 2023/04/12 07:32:56 by uisroilo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Server::ft_print_users() const {
	std::cout << GREEN << "/* ******************************************************************************* */\n";
	std::cout << "/* Fds           Nick        Username   Operator    isAuth   Channels                         */\n";
	for (size_t i = 0; i < _Users.size(); i++) {
		...
		if (_Users[i].getUserOPER())
			...
			std::cout << "false";
		std::cout << std::left << std::setfill(' ') << std::setw(9);
		if (_Users[i].getIsAuth())
			std::cout << "true";
		else
			std::cout << "false";
